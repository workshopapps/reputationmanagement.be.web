...
namespace src.Migrations
{
    ...
    [Migration("20221210123556_AddNullableAboutTheReviewFieldToQuoteModel")]
    partial class AddNullableAboutTheReviewFieldToQuoteModel
    {
            ...
            modelBuilder.Entity("src.Entities.BlogEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7520),
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7544),
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7546),
                        ...
                        {
                            Id = 4,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7547),
                        ...
                        {
                            Id = 5,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7548),
                        ...
                        {
                            Id = 6,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7553),
                        ...
                        {
                            Id = 7,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7554),
                        ...
                        {
                            Id = 8,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7555),
                        ...
                        {
                            Id = 9,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7557),
                        ...
                        {
                            Id = 10,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7559),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1NZY_9xSFlzQ2_OrOThoZlXQUap77k18A",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 11,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7560),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1YNXXb3_mVJePpK3JPbknuTomNpvuBIAl",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 12,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7561),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1eJQLcMxgObTqbKYc3jujQsvgAd72fQa-",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 13,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7562),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 14,
                            CreationDate = new DateTime(2022, 12, 10, 13, 35, 56, 173, DateTimeKind.Local).AddTicks(7563),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
