...
namespace src.Migrations
{
    ...
    [Migration("20221211121915_AllowLawyerEmailFieldBeNullable")]
    partial class AllowLawyerEmailFieldBeNullable
    {
            ...
            modelBuilder.Entity("src.Entities.BlogEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6927),
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6950),
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6953),
                        ...
                        {
                            Id = 4,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6954),
                        ...
                        {
                            Id = 5,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6956),
                        ...
                        {
                            Id = 6,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6960),
                        ...
                        {
                            Id = 7,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6962),
                        ...
                        {
                            Id = 8,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6963),
                        ...
                        {
                            Id = 9,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6965),
                        ...
                        {
                            Id = 10,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6967),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1NZY_9xSFlzQ2_OrOThoZlXQUap77k18A",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 11,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6969),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1YNXXb3_mVJePpK3JPbknuTomNpvuBIAl",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 12,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6970),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1eJQLcMxgObTqbKYc3jujQsvgAd72fQa-",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 13,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6972),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 14,
                            CreationDate = new DateTime(2022, 12, 11, 13, 19, 15, 381, DateTimeKind.Local).AddTicks(6973),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
