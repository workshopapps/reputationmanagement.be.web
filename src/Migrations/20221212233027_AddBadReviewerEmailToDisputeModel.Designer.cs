...
namespace src.Migrations
{
    ...
    [Migration("20221212233027_AddBadReviewerEmailToDisputeModel")]
    partial class AddBadReviewerEmailToDisputeModel
    {
            ...
            modelBuilder.Entity("src.Entities.BlogEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1752),
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1770),
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1772),
                        ...
                        {
                            Id = 4,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1773),
                        ...
                        {
                            Id = 5,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1821),
                        ...
                        {
                            Id = 6,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1825),
                        ...
                        {
                            Id = 7,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1826),
                        ...
                        {
                            Id = 8,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1827),
                        ...
                        {
                            Id = 10,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1829),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1NZY_9xSFlzQ2_OrOThoZlXQUap77k18A",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 11,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1830),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1YNXXb3_mVJePpK3JPbknuTomNpvuBIAl",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 12,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1831),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1eJQLcMxgObTqbKYc3jujQsvgAd72fQa-",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 13,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1832),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 14,
                            CreationDate = new DateTime(2022, 12, 13, 0, 30, 27, 481, DateTimeKind.Local).AddTicks(1833),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
