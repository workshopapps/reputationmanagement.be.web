...
namespace src.Migrations
{
    ...
    [Migration("20221214160447_AddPricePropertyToReviewModel")]
    partial class AddPricePropertyToReviewModel
    {
            ...
            modelBuilder.Entity("src.Entities.BlogEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 218, DateTimeKind.Local).AddTicks(9980),
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(20),
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(25),
                        ...
                        {
                            Id = 4,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(28),
                        ...
                        {
                            Id = 5,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(31),
                        ...
                        {
                            Id = 6,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(41),
                        ...
                        {
                            Id = 7,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(44),
                        ...
                        {
                            Id = 8,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(46),
                        ...
                        {
                            Id = 9,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(49),
                        ...
                        {
                            Id = 10,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(175),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1NZY_9xSFlzQ2_OrOThoZlXQUap77k18A",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 11,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(181),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1YNXXb3_mVJePpK3JPbknuTomNpvuBIAl",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 12,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(183),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=1eJQLcMxgObTqbKYc3jujQsvgAd72fQa-",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 13,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(186),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
                        ...
                        {
                            Id = 14,
                            CreationDate = new DateTime(2022, 12, 14, 17, 4, 47, 219, DateTimeKind.Local).AddTicks(188),
                            Description = "Defamation removal can be challenging. With our step-by-step guide, learn how to protect ...",
                            PathToImage = "https://drive.google.com/uc?export=view&id=17ihd1n1_xPrEPDdQTO2S87ERAxQqkoJQ",
                            Tag = "Reputation Management",
                            Title = "How to Do Defamation Removal Online",
